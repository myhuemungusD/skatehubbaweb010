                          ...
                          <Button
                            ...
                            className={`h-14 text-lg font-semibold rounded-lg transition-all ${
                              selectedAmount === amount
                                ...
                                : "bg-gray-800 border-gray-600 text-[#fafafa] hover:bg-gray-700 hover:border-orange-400"
                            }`}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 bg-gray-800 border-gray-600 text-[#fafafa] placeholder-gray-400 h-12 text-lg"
