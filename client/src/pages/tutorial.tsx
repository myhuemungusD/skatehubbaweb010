...
export default function Tutorial({ userId }: TutorialProps) {
  ...
  const { data: tutorialSteps, isLoading: stepsLoading } = useQuery<
    TutorialStep[]
  >({
  ...
  const completeOnboardingMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description:
          "Welcome to SkateHubba! You're ready to start your skating journey.",
      });
            ...
            <Card className="bg-black/60 border-gray-600 backdrop-blur-sm">
              ...
              <CardContent className="space-y-6">
                ...
                {currentStep.type === "challenge" &&
                  currentStep.content?.challengeData && (
                    <div className="space-y-4">
                      <h4 className="text-orange-400 font-semibold">
                        Challenge:
                      </h4>
                      <div className="p-4 bg-purple-500/10 rounded-lg border border-purple-500/30">
                        <p className="text-[#fafafa] mb-2">
                          ...
                          {currentStep.content.challengeData.action}
                        </p>
                        <p className="text-gray-300">
                          <strong>Goal:</strong>{" "}
                          {currentStep.content.challengeData.expectedResult}
                        </p>
                      </div>
                    </div>
                  )}
          ...
          <div className="mt-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {tutorialSteps.map((step, index) => {
                const stepProgress = userProgress?.find(
                  (p) => p.stepId === step.id,
                );
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          <h4 className="font-semibold text-[#fafafa] text-sm">
                            {step.title}
                          </h4>
