...
export default function Home() {
  ...
  const handleAppStoreDownload = () => {
    toast({
      title: "Coming Soon!",
      description: "SkateHubba will be available on the App Store soon.",
    });
  };
  ...
  const handleGooglePlayDownload = () => {
    toast({
      title: "Coming Soon!",
      description: "SkateHubba will be available on Google Play soon.",
    });
  };
  ...
  const handleBetaSignup = () => {
    toast({
      title: "Beta Access!",
      description: "Join our beta program for early access to SkateHubba.",
    });
  };
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              className="group bg-skatehubba-primary hover:bg-skatehubba-primary-hover text-white font-bold py-4 px-8 text-base transition-all duration-300 transform hover:scale-105 hover:shadow-xl flex items-center gap-3 min-w-[250px]"
            >
        ...
        <section className="py-16 lg:py-24 bg-skatehubba-primary relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <p className="text-lg sm:text-xl mb-8 max-w-2xl mx-auto text-white/90 leading-relaxed">
              Be the first to join the SkateHubba beta. Create your account to earn welcome bonuses 
              and secure your username.
            </p>
            
            <Button 
              onClick={handleBetaSignup}
              className="group inline-flex items-center gap-3 bg-white text-skatehubba-primary font-bold py-5 px-12 text-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:bg-gray-50"
            >
