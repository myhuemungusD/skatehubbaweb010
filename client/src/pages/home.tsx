    ...
    <BackgroundCarousel className="text-[#fafafa]">
      ...
      <div className="bg-orange-500 text-white text-center py-3">
        <div className="container mx-auto px-4">
          <strong>BETA VERSION</strong> - We need your feedback to make
          SkateHubba even better!
          <a
      ...
      >
        <div className="text-center">
                ...
                <div className="text-center lg:text-left space-y-6 md:space-y-8 px-4 lg:px-0">
                  ...
                  <div className="space-y-4 max-w-full">
                    ...
                    <div className="bg-black/30 rounded-lg p-4 border border-gray-600/30 max-w-full">
                      <h4 className="text-orange-400 font-semibold mb-3 text-center lg:text-left">
                        What's inside:
                      </h4>
            ...
            <div className="container mx-auto px-4">
              <div className="text-center max-w-4xl mx-auto">
                <h2 className="text-4xl md:text-6xl font-black text-[#fafafa] mb-8 font-orbitron leading-tight">
                  Your tricks are worth more than likes—now they're
                  collectibles.
                </h2>
                <div className="text-left bg-black/50 rounded-2xl p-8 border border-orange-400/30">
                  ...
                  <div className="space-y-4 text-[#fafafa] text-lg leading-relaxed">
                    <p>
                      Land a banger? Now it's more than just a clip. With
                      SkateHubba, your best tricks and legendary spot moments
                      can be minted as one-of-a-kind digital collectibles.
                      They're locked on the blockchain—so they can't be faked,
                      copied, or lost.
                    </p>
                    <p>
                      Trade rare gear, earn exclusive drops from your favorite
                      pros, and unlock secret challenges only available to
                      collectible holders. From a first-try rail to an MBD at
                      your local spot, SkateHubba lets you own your moment, flex
                      it forever, and even get rewarded for it.
                    </p>
                  </div>
          ...
          <section className="mb-12 bg-black/40 rounded-2xl p-8">
            <h3 className="text-3xl font-bold mb-8 text-[#fafafa] text-center font-orbitron">
              Development Roadmap
            </h3>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="border-l-4 border-orange-400 pl-6">
                <h4 className="text-2xl font-bold text-orange-400 mb-4 font-orbitron">
                  Phase 1: Core Loop & Community
                </h4>
                <div className="space-y-3 text-[#fafafa]">
                  <p>
                    <strong>Remote S.K.A.T.E. Battles:</strong> Video upload,
                    challenge/response, 24-hour timer, and basic trick
                    validation (manual at first, AI-assisted later).
                  </p>
                  <p>
                    <strong>Map & Check-Ins:</strong> Geolocation map with skate
                    spots, shops, and parks. Check-in for rewards and see who's
                    nearby.
                  </p>
                  <p>
                    <strong>Live Sessions:</strong> Simple live stream/spectate
                    feature, plus a "Trenches" feed for clips and feedback.
                  </p>
                  <p>
                    <strong>Closet & Avatars:</strong> Basic avatar
                    customization and digital closet for gear flexing.
                  </p>
                </div>
              </div>
              ...
              <div className="border-l-4 border-orange-400 pl-6">
                ...
                <div className="space-y-3 text-[#fafafa]">
                  <p>
                    <strong>Crews & Rep:</strong> Crew creation, stats, badges,
                    and leaderboards.
                  </p>
                  <p>
                    <strong>Trading & Collectibles:</strong> Item trading with
                    rarity/history, daily challenges, and coin/cosmetic rewards.
                  </p>
                  <p>
                    <strong>Notifications & Chat:</strong> Real-time alerts and
                    WebSocket chat for battles and sessions.
                  </p>
                </div>
              </div>
              ...
              <div className="border-l-4 border-orange-400 pl-6">
                <h4 className="text-2xl font-bold text-orange-400 mb-4 font-orbitron">
                  Phase 3: AR & Advanced Features
                </h4>
                <div className="space-y-3 text-[#fafafa]">
                  <p>
                    <strong>AR Spot Check-Ins:</strong> Camera overlay for
                    immersive check-ins and navigation.
                  </p>
                  <p>
                    <strong>Advanced Customization:</strong> More avatar/closet
                    options, limited drops, and pro features.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="signup" className="py-16 bg-black/50 rounded-2xl mb-12">
            <div className="container mx-auto px-4 text-center">
              <h3 className="text-3xl md:text-4xl font-bold mb-5 text-[#fafafa] font-orbitron">
                Get SkateHubba Updates
              </h3>
              <p className="text-lg text-gray-300 mb-8 max-w-xl mx-auto">
                Sign up for exclusive content, early access to features, and
                news about the SkateHubba community.
              </p>
              <EmailSignup />
            </div>
          </section>
      ...
      <section className="py-12 bg-black/50">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-6 text-[#fafafa] font-orbitron">
            Follow Us
          </h3>
          <p className="text-lg mb-8 text-[#fafafa]">
            Stay in the loop and connect with the culture:
          </p>
      ...
      >
        <div className="bg-[#232323] text-[#fafafa] p-8 rounded-lg max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
          ...
          <p className="mb-4">
            <strong>Effective date: August 2025</strong>
          </p>
          <p className="mb-4">
            SkateHubba collects your name and email only for the purpose of
            sending you updates and news. We do not share or sell your personal
            data with anyone.
          </p>
          <p className="mb-4">
            You may unsubscribe at any time by clicking the link in any email.
            We do not use cookies or tracking, except those necessary for site
            function.
          </p>
        </div>
      </div>
      ...
      >
        <div className="bg-[#232323] text-[#fafafa] p-8 rounded-lg max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
          ...
          <p className="mb-4">
            By using SkateHubba, you agree to these terms. The service is
            provided as-is for skateboarding community engagement.
          </p>
          <p className="mb-4">
            Users must be respectful and follow community guidelines. We reserve
            the right to moderate content and remove inappropriate material.
          </p>
        </div>
      </div>
      ...
      >
        <div className="bg-[#232323] text-[#fafafa] p-8 rounded-lg max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
          ...
          <p className="mb-4">
            SkateHubba is committed to providing an accessible experience for
            all users. We follow WCAG guidelines and continuously improve our
            accessibility features.
          </p>
          <p className="mb-4">
            If you encounter any accessibility issues, please contact us at
            hello@skatehubba.com and we'll work to address them promptly.
          </p>
        </div>
      </div>
    </BackgroundCarousel>
