 ...
 * - Anonymous users are authenticated (allows guest browsing/interactions)
 * - Users with verified emails are authenticated
 * - Users authenticated via OAuth providers (Google, phone, etc.) are authenticated
 *   without requiring email verification, as these providers handle identity verification
 */
