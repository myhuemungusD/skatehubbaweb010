    ...
    switch (variant) {
      ...
      case "sidebar":
        return {
          ...
          button:
            "bg-orange-500 hover:bg-orange-600 text-white w-full font-semibold",
        };
      default:
        return {
          container: "max-w-md space-y-4",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        setValidationError(
          error.errors[0]?.message || "Please check your input",
        );
      } else {
        toast({
          title: "Signup failed",
      ...
      <div className={`${styles.container} ${className}`}>
        <div className="bg-green-500/20 border border-green-400 rounded-xl p-6 text-center">
          ...
          <p className="text-green-300 mb-4">
            Get ready for updates, drops & exclusive sessions.
          </p>
          <button
